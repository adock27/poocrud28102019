...
public class FrmCrudCategorias extends javax.swing.JFrame {
    ...
    public FrmCrudCategorias() throws Exception {
        ...
        objContCat.setCategoria(new Categoria("1", "Carnes", "Activo"));
        objContCat.setCategoria(new Categoria("2", "lacteos", "Activo"));
        objContCat.setCategoria(new Categoria("3", "verduras", "Activo"));
        objContCat.setCategoria(new Categoria("4", "tuberculos", "Activo"));
        objContCat.setCategoria(new Categoria("5", "pescados", "Activo"));
